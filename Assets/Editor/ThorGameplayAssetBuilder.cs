    ...
    public static class ThorGameplayAssetBuilder
    {
        ...
        public static void Build()
        {
            ...
            GameObject thorPlayerPrefab = BuildThorPlayerPrefab(
                ...
                mjolnirPrefab,
                lightningMaterial);
            BuildMatchPrefab(thorPlayerPrefab);
            ...
            Debug.Log(
                ...
                "use Arena_ThorVRTest for the integrated playtest.");
        }
        ...
        private static void BuildThorArenaScene()
        {
            ...
            GameObject matchPrefab =
                AssetDatabase.LoadAssetAtPath<GameObject>(ThorMatchPrefabPath);
            PrefabUtility.InstantiatePrefab(matchPrefab, scene);
            EditorSceneManager.SaveScene(scene, ThorArenaPath);
        }
